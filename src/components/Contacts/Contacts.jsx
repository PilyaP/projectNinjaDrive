       ...
       <div className={s.contactsWrapper} >
          ...
          <div className={s.info}>
            <div className={s.contactsMap}>
              <h2 className={s.contactsHeading}>Контакти</h2>
              <div className={s.contactTel}>
                <p className={s.contactFat}>Телефон</p>
                <a className={s.contactThink} href="tel:+380960020777">
                  +38 (096) 00 20 777
                </a>
              </div>
              <div className={s.contactAdress}>
                <p className={s.contactFat}>Адреса</p>
                <a
                  className={s.contactThink}
              ...
              <p className={s.contactFat}>Соц. мережі</p>
              <div>
